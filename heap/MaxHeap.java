public class MaxHeap {
    ...
    private void printTreeHelper(int pos, String indent) {
        if (pos < size) {
            printTreeHelper(rightChild(pos), indent + "   ");
            System.out.println(indent + Heap[pos]);
            printTreeHelper(leftChild(pos), indent + "   ");
        }
    }
	// Method 10
	// main driver method
	public static void main(String[] arg)
	{
        ...
        System.out.println("Visual representation of the Max Heap:");
        maxHeap.printTree();
	}
}
